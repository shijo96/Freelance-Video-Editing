				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mx-auto">
						<li class="nav-item active">
							<a class="nav-link ml-lg-0" href="client_home.php">Home
                        ...
                        <li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item text-center " href="client_view_services.php">Services</a>
                                <a class="dropdown-item text-center " href="client_view_request.php">Request</a>
								
							</div>
						</li>
                        <li class="nav-item">
							<a class="nav-link " href="client_send_complaints.php">Complaint</a>
						</li>
